...
const Navbar = ({ initialMenuOpen = false, initialSearchOpen = false }) => {
     ...
     return (
          <>
               <nav className="w-full border-b border-yellow-500/10 bg-black font-urbanist sticky top-0 z-50">
          ...
          <div 
               ...
               className={`w-full fixed left-0 right-0 bottom-0 top-0 md:top-12 z-40 bg-black/20 backdrop-blur-lg flex items-center justify-center p-4 md:p-6 transition-all duration-400 hide-scrollbar ease-in-out ${
                    isCoursesModalOpen ? "translate-y-0 opacity-100 pointer-events-auto" : "-translate-y-full pointer-events-none"
               }`}
          >
