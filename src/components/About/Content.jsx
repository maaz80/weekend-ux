...
const Content = () => {
  return (
       <div className="relative py-9 md:py-15 custom-width px-0 md:px-5">
            <div className='text-[32px] md:text-[40px] text-neutral-900 text-center font-urbanist max-w-230 mx-auto'>“Design can't be learned by watching someone else design. Weekend UX exists because the only way to get better is to sit down, make something, and get honest feedback on it.”</div>
