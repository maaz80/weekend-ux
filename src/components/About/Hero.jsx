...
export default function Hero({
     ...
     return (
          <div className=" bg-white text-white font-urbanist flex flex-col relative pt-16 md:pt-8">
               <Image src='/images/weekend-ux-decorative-diamond.webp' alt="weekend-ux-decorative-diamond" className="w-24 md:w-50 h-auto absolute left-3 md:left-10 -bottom-8 md:-bottom-16 z-30" width={96} height={93} style={{ height: 'auto' }}/>
               {/* Hero Header Section */}
               <section id="about-hero" className={`relative h-62.5 md:h-120 w-full flex flex-col gap-5 items-center justify-center overflow-hidden ${bgColor}`}>
                    <OptimizedImage
                         src={bgImage}
