...
export default function LocationDetailsView({ data }) {
     ...
     return (
          <main className="min-h-screen bg-white text-neutral font-urbanist">
               {/* 1. HERO SECTION */}
               <div className="bg-white text-white font-urbanist flex flex-col relative">
                    ...
                    {/* <Image 
                         ...
                         style={{ height: 'auto' }}
                    /> */}
                    <section className="relative h-86.5 md:h-114 w-full flex flex-col gap-2 md:gap-5 items-center pb-6 md:pb-20  justify-end md:justify-end bg-neutral overflow-hidden" data-navbar-light="true" id='location-hero'>
                         <Image
                         ...
                         {heroBtn && (
                              <Link href="/courses">
                                   <Button
                                        ...
                                        className="font-urbanist relative z-50"
                                   >
                                        {heroBtn}
                                   </Button>
                              </Link>
