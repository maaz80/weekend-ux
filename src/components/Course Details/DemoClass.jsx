               ...
               <div className="custom-width px-4 sm:px-6 lg:px-16 mx-auto">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 lg:gap-12 items-center">
                         ...
                         <div className="w-full min-w-0 flex justify-center sm:justify-end">
                              <div className="w-full max-w-91.25 bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl border border-zinc-200/90 hover:-translate-y-1 transition-all duration-300">
